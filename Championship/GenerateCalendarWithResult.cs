...
public class GenerateCalendarWithResult
{
    ...
    public Calendar GenerateCalendarWithScores(List<TeamRecord> teams)
    {
        ...
        MatchWithResult GenerateMatchWithResult(TeamRecord homeTeam, TeamRecord awayTeam, DateTime matchDate)
        {
        ...
        for (int i = 0; i < numMatchdays; i++)
        {
            ...
            for (int j = 0; j < numTeams / 2; j++)
            {
                ...
                MatchWithResult matchWithResult = GenerateMatchWithResult(homeTeam, awayTeam, matchDate);
